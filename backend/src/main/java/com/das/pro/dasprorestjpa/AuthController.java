...
// @PostMapping("/login")
// public ResponseEntity<Map<String, Object>> login(@RequestBody UserInfoEntity
// loginRequest) {
// Map<String, Object> response = new HashMap<>();
// try {
// String token = authService.authenticateUser(loginRequest.getUser_id(),
// loginRequest.getPassword());
// UserInfoEntity user =
// loginRepo.findById(loginRequest.getUser_id()).orElse(null);
...
// @PostMapping("/signup")
// public ResponseEntity<Map<String, Object>> signup(@RequestBody UserInfoEntity
// user) {
// Map<String, Object> response = new HashMap<>();
// try {
// authService.registerUser(user);
